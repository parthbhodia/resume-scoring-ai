...
*Last updated: 2026-06-13 — Profile-aware jobs feed + onboarding chip UX shipped (api `369b687`, web `e9b67fb` on staging). Next session: read this file first, update it last.*
