...
from resume_gui.analysis import (
...
from resume_gui.extract import (
...
from resume_gui.extract.doc_normalize import (
    ...
    _normalize_structured_contact,
    _normalize_structured_education,
    _normalize_structured_experience,
    _normalize_structured_skills,
    _parse_entry_header,
)
from resume_gui.extract.education_parse import (
    _collect_education_flat_lines,
    _education_item_from_combined_line,
    _education_item_from_dict,
    _education_items_from_flat_lines,
)
from resume_gui.extract.structured_doc import (
    _build_resume_doc_from_llm_raw,
    _doc_extraction_counts,
    _project_items_from_llm_projects,
    _project_items_from_prefixed_bullets,
